...
export default class Dentalclg extends React.Component {
  render() {
    return (
      <div>
        <table className="medicaltable">
          <tbody>
            ...
            <tr>
              <td>12</td>
              <td>Institute of Liver and Biliary Sciences, New Delhi</td>
              <td>Delhi</td>
              <td>61.29</td>
            </tr>
            <tr>
              <td>13</td>
              <td>St. John’s Medical College, Bengaluru</td>
              <td>Karnataka</td>
              <td>60.83</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>20</td>
              <td>S.R.M. Institute of Science and Technology, Chennai</td>
              <td>Tamil Nadu</td>
              <td>55.74</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>26</td>
              <td>Dayanand Medical College, Ludhiana</td>
              <td>Punjab</td>
              <td>53.13</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>29</td>
              <td>Government Medical College &amp; Hospital, Chandigarh</td>
              <td>Chandigarh</td>
              <td>51.9</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>34</td>
              <td>Datta Meghe Institute of Medical Sciences, Wardha</td>
              <td>Maharashtra</td>
              <td>51.52</td>
            </tr>
            <tr>
              <td>35</td>
              <td>Maharishi Markandeshwar, Ambala</td>
              <td>Haryana</td>
              <td>50.96</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>37</td>
              <td>M. S. Ramaiah Medical College, Bengaluru</td>
              <td>Karnataka</td>
              <td>50.05</td>
            </tr>
            <tr>
              <td>38</td>
              <td>Sawai Man Singh Medical College, Jaipur</td>
              <td>Rajasthan</td>
              <td>49.65</td>
            </tr>
            <tr>
              <td>39</td>
              <td>SCB Medical College and Hospital, Cuttack</td>
              <td>Odisha</td>
              <td>49.42</td>
            </tr>
            <tr>
              <td>40</td>
              <td>Annamalai University, Annamalainagar</td>
              <td>Tamil Nadu</td>
              <td>49.13</td>
            </tr>
            <tr>
              <td>41</td>
              <td>Padmashree Dr. D. Y. Patil Vidyapeeth, Mumbai</td>
              <td>Maharashtra</td>
              <td>48.07</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>43</td>
              <td>Narayana Medical College, Sri Potti Sriramulu Nellore</td>
              <td>Andhra Pradesh</td>
              <td>46.5</td>
            </tr>
            <tr>
              <td>43</td>
              <td>Regional Institute of Medical Sciences, Imphal West</td>
              <td>Manipur</td>
              <td>46.5</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>47</td>
              <td>Jawaharlal Nehru Medical College, Belagavi</td>
              <td>Karnataka</td>
              <td>46.04</td>
            </tr>
            <tr>
              <td>48</td>
              <td>Tirunelveli Medical College, Tirunelveli</td>
              <td>Tamil Nadu</td>
              <td>46.03</td>
            </tr>
            <tr>
